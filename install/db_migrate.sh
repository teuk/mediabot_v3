...
MODS["PUBLIC_COMMANDS"]="MODIFY \`id_public_commands\` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT, MODIFY \`id_user\` BIGINT UNSIGNED DEFAULT NULL, MODIFY \`id_public_commands_category\` BIGINT UNSIGNED NOT NULL, MODIFY \`hits\` BIGINT UNSIGNED NOT NULL DEFAULT 0"

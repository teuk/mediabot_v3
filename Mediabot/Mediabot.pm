...
# AI
ai|ai <prompt>|public|Ask Claude. Subcommands: summary (Administrator+) [periode] [N] [Nl] [public] [en|fr|es] [nick] (details: ai summary help), pin, relay, forget, models, stats, reset, history, ai persona.
